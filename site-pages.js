...
const articles = [
  {
    ...
    date: "July 2026",
    time: "6 min read",
    image: "assets/accessible-inclusive-reliable.png",
  ...
  },
  {
    ...
    date: "June 2026",
    time: "5 min read",
    image: "assets/hero-terminal.png",
  ...
  },
  {
    ...
    date: "May 2026",
    time: "4 min read",
    image: "assets/experience-accessibility.jpg",
...
const pages = {
  about: {
    ...
    intro: {
      ...
      image: "assets/connecting-passengers-operators-cities.png",
    ...
    gallery: [
      ["assets/bus .png", "Universal city and intercity vehicles"],
      ["assets/ud terminal .png", "Mobility hubs built around Universal Design"],
      ["assets/electric car.png", "Inclusive private and family mobility"],
    ],
  ...
  solutions: {
    ...
    intro: {
      ...
      image: "assets/electric bus .png",
      alt: "Kencid Mobility electric bike-share station for short urban trips",
    },
    solutionCards: [
      ["Universal City Bus", "Safe, efficient, dignified public transport with foldable seats, tactile flooring, multi-sensory information, wide circulation, smart displays, and emergency systems.", "assets/bus .png"],
      ["Universal Intercity Coach", "Long-distance travel measured by comfort, dignity, safety, passenger information, flexible interiors, smart lighting, and premium experience.", "assets/van .png"],
      ["Universal School Bus", "Child-centered safety, GPS tracking, smart notifications, driver monitoring, emergency systems, and inclusive design for diverse learners.", "assets/low floor easy acces .png"],
      ["Universal Private Mobility", "Family, executive, healthcare, hospitality, senior-friendly, and electric mobility that is inclusive, beautiful, and intelligent.", "assets/electric car.png"],
      ["Universal Mobility Hubs", "Arrival zones, passenger lounges, smart ticketing, family zones, universal restrooms, operations centres, safety areas, and green spaces.", "assets/ud terminal .png"],
      ["Smart Mobility Platform", "Journey planning, real-time tracking, smart ticketing, passenger alerts, accessibility support, fleet intelligence, and data analytics.", "assets/Audio information .png"],
    ],
    featureGrid: [
    ...
    bands: [
      {
        ...
        image: "assets/electric taxi .png",
  ...
  technology: {
    ...
    icon: "tech",
    hero: "assets/smart-mobility-technology.png",
    intro: {
      ...
      image: "assets/experience-app.jpg",
      alt: "Passenger planning a trip on the Kencid Mobility app",
    },
    solutionCards: [
      ["Passenger Mobility Platform", "Journey planning, real-time vehicle tracking, smart ticketing, passenger alerts, accessibility support, and emergency assistance put mobility information directly in passengers' hands.", "assets/Audio information .png"],
      ["Smart Ticketing Platform", "Mobile money, QR codes, contactless cards, institutional passes, and student and corporate mobility accounts replace cash-based fare collection with transparent digital payments.", "assets/terminals.png"],
      ["Fleet Intelligence Platform", "Vehicle tracking, driver monitoring, fuel and energy management, maintenance alerts, passenger counts, and safety monitoring help operators run safer, more reliable fleets.", "assets/electric taxi .png"],
      ["AI Mobility Intelligence", "Future route optimization, scheduling, fleet deployment, passenger demand forecasting, maintenance planning, and energy consumption modelling turn mobility into a data-driven system.", "assets/HEROES 2.png"],
    ],
  ...
  terminals: {
    ...
    gallery: [
      ["assets/clear way finding .png", "Clear wayfinding across every zone"],
      ["assets/Audio information .png", "Self-service ticketing and information kiosks"],
      ["assets/accessible toilets .png", "Universal restrooms in every terminal"],
      ["assets/tactile guidance.png", "Tactile guidance from arrival to boarding"],
    ],
  ...
  "design-experience": {
    ...
    gallery: [
      ["assets/experience-terminal.jpg", "Observing real passenger flow inside a transport hub"],
      ["assets/experience-accessibility.jpg", "Studying accessibility across the full journey"],
      ["assets/tactile guidance.png", "Testing tactile and multi-sensory guidance"],
    ],
  ...
  manufacturing: {
    ...
    gallery: [
      ["assets/HEROES 2.png", "The Kencid UD Terminal precinct, delivered through the manufacturing ecosystem"],
      ["assets/terminals.png", "Smart terminal fit-out delivered by Kencid Mobility's manufacturing ecosystem"],
    ],
  ...
  "universal-design": {
    ...
    icon: "universal",
    hero: "assets/full accessibility .png",
    intro: {
      ...
      image: "assets/step free acces.png",
    ...
    gallery: [
      ["assets/wide doors.png", "Wide, step-free boarding with tactile guidance"],
      ["assets/low floor easy acces .png", "Low-floor interiors built for easy, unaided access"],
      ["assets/clear way finding .png", "Clear, high-contrast wayfinding at every stop"],
      ["assets/Audio information .png", "Interactive kiosks with audio and visual journey information"],
      ["assets/accessible toilets .png", "Fully accessible restrooms at mobility hubs"],
      ["assets/passenger-assistance-render-crop.png", "Braille and audio passenger assistance points"],
      ["assets/fire-safety-render-crop.png", "Integrated emergency and fire safety systems"],
    ],
    ...
    bands: [
      {
        ...
        image: "assets/ud-bus-interior.png",
  ...
  article: {
    ...
    icon: "news",
    hero: "assets/accessible-inclusive-reliable.png",
    isArticle: true,
  },
  contact: {
    title: "Contact Us",
  ...
  return `
    <header class="site-header">
      <a class="brand" href="index.html" aria-label="Kencid Mobility home">
        <img src="assets/kencid-logo.png" alt="Kencid Mobility">
      </a>
    ...
    <footer class="site-footer" id="contact" aria-label="Kencid Mobility footer">
      <div class="footer-main">
        <div class="footer-brand-block">
          <a class="footer-logo" href="index.html" aria-label="Kencid Mobility home"><img src="assets/kencid-logo.png" alt="Kencid Mobility"></a>
  ...
  return `
    ...
    <section class="news-hub page-section">
      <article class="featured-article reveal-on-scroll">
        ...
        <div><span>${articles[0].category} · ${articles[0].date}</span><h2>${sectionTitle(articles[0].title)}</h2><p>${articles[0].excerpt}</p><a class="hero-action about-cta" href="article.html"><span>Read article</span>${arrowIcon}</a></div>
      </article>
...
function articleMarkup(page) {
  return `
    ...
    <article class="article-body">
      <div class="article-meta">Universal Design · July 2026 · 6 min read</div>
      ...
      <figure><img src="assets/tactile guidance.png" alt="Tactile guidance and accessible passenger movement inside a transport environment" loading="lazy" decoding="async"></figure>
...
function ctaMarkup() {
  return `
    <section class="global-cta reveal-on-scroll">
      <img src="assets/SLIDE 6 .png" alt="" loading="lazy" decoding="async">
